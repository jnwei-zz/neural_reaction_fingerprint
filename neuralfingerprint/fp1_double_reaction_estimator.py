...
class rxn_estimator(BaseEstimator, RegressorMixin):
    ...
    def parse_training_params(self):
        ...
        # Adjust for double/triple
        vanilla_net_params = {'layer_sizes': [self.fp_length*2, self.other_param_dict['h1_size']],  # Linear regression.
        ...
        if type(self.other_param_dict['h1_size']) == list:
    ...
    def fit(self, X, y):
        ...
        def morgan_run(X,y):
            ...
            loss_fun, pred_fun, net_parser = \
                build_double_morgan_deep_net(fp_params['fp_length'], fp_params['fp_radius'], vanilla_net_params)#, self.log_l2_penalty)
        ...
        def neural_run(X,y):
            ...
            loss_fun, pred_fun, conv_parser = \
                build_double_conv_deep_net(conv_arch_params, vanilla_net_params)
