...
#X = pkl.load(open('02k_50enr_train_inputs_1.dat')) 
#y = pkl.load(open('02k_50enr_train_targets.dat')) 
...
train_space = (hp.uniform('log_learn_rate', -4, -1.5),
               ...
               # for morgan: 
               #hp.quniform('fp_length', 1, 1024,1 ))
               # for neural: 
...
if __name__ == '__main__':
    ...
    #!# Set every time
    with open('neural1_bal_200each_train_100runs.dat','w') as resultf:
