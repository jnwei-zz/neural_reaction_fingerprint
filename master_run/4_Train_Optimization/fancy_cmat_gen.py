'''
Labelled cmat display borrowed from Schneider et al. DOI: 10.1021/ci5006614
'''
...
def labelled_cmat(cmat,labels,#figsize=(20,15),
    ...
    #fig.set_dpi(dpi)
    pax=ax.pcolor(ncm,cmap=plt.get_cmap('Blues',100000),vmin=0, vmax=1)#cm.ocean_r)
    ...
    if xlabel:
        ...
        plt.xlabel('Predicted reaction label')
    ...
    if ylabel:
        ...
        plt.ylabel('True reaction label')
