...
exam_analysis.py:
- compile the results of all of the different methosd

questions_in_train_set.py :
- Compare the similarity of the exam questions to the training set questions

heat_map_disp.py:
- Code for generating a heatmap of the prediction results for each method
